...
## Step 1: ssh connect to ssh-keygen and aggregate rsa public keys. use here document to execute multiple commands in command line

# dummy_command = """<< EOF\necho {} >> /nfs/testfile\necho {} >> /nfs/testfile\nexit\nEOF\n"""
# kgw_command = """<< EOF\nssh-keygen -N -t '' -f ~/.ssh/id_rsa <<< y\ncat ~/.ssh/id_rsa.pub >> /nfs/id_agg.pub\nexit\nEOF\n"""
